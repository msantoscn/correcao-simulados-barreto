      ...
      <div className="lg:col-span-2 bg-white rounded-md border border-[#dbc8b6] p-4 sm:p-5 transition-all overflow-hidden shadow-sm">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-4 pb-3 border-b border-[#dbc8b6]">
          ...
          {idEmEdicao && (
            <button
              ...
              className="w-full sm:w-auto text-xs font-bold text-gray-700 bg-gray-100 hover:bg-gray-200 border border-[#dbc8b6] px-3 py-2 rounded-md uppercase flex items-center justify-center gap-1.5 transition cursor-pointer shrink-0 active:scale-95"
            >
        ...
        <form onSubmit={guardarSimulado} className="space-y-5">
          ...
          <div className="space-y-3.5">
            <h3 className="text-xs font-bold text-gray-600 uppercase tracking-widest border-b border-[#dbc8b6] pb-2">
          ...
          <div className="space-y-2.5 pt-2">
            ...
            <button
              type="submit"
              className="w-full py-2.5 px-4 bg-blue-500 hover:bg-blue-600 text-white font-bold text-xs uppercase tracking-wider rounded-md flex items-center justify-center gap-2 transition cursor-pointer shadow-sm active:scale-[0.99]"
            >
...
function SimuladoCard({ sim, emEdicao, aoEditar, aoDuplicar, aoRemover }) {
  return (
    ...
    >
      ...
      <div className="flex items-center gap-1.5 pt-2 border-t border-[#dbc8b6] flex-wrap sm:flex-nowrap">
        <button
          onClick={aoEditar}
          className="flex-1 py-1.5 px-2.5 bg-gray-50 hover:bg-blue-500 text-gray-700 hover:text-white border border-[#dbc8b6] text-xs font-bold uppercase tracking-wider rounded-md flex items-center justify-center gap-1 transition cursor-pointer active:scale-95"
        >
          <Edit3 className="w-3.5 h-3.5" /> Editar
        </button>
        <button
          onClick={aoDuplicar}
          className="py-1.5 px-2.5 bg-gray-50 hover:bg-gray-200 text-gray-700 border border-[#dbc8b6] text-xs font-bold uppercase tracking-wider rounded-md flex items-center justify-center gap-1 transition cursor-pointer active:scale-95"
